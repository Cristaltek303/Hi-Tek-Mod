...
import cristaltek.hitekmod.util.StackHelper;
...
public class CraftingTabletContainer extends Container {
    ...
    public CraftingTabletContainer(EntityPlayer player /*, InventoryCraftingTablet CraftingTabletInventory*/) {
    	this.player = player;
    	...
    	// Crafting output slot
         this.addSlotToContainer(new SlotCrafting(player, craftingMatrix, craftingResult, 0, 136, 35));

         // Crafting Grid
         for (int i = 0; i < 3; ++i) {
             for (int j = 0; j < 3; ++j) {
                 this.addSlotToContainer(new Slot(craftingMatrix, j + i * 3, 42 + j * 18, 17 + i * 18));
             }

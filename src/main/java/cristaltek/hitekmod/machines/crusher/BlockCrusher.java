...
public class BlockCrusher extends BlockMachine implements ITileEntityProvider
{
	public BlockCrusher()
	{
		super(Material.iron, "Crusher", ItemBlockCrusher.class);
		GameRegistry.registerTileEntity(TileEntityCrusher.class, "tileCrusher");
	}
	
	@Override
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float xOffset, float yOffset, float zOffset)
	{
		player.openGui(HiTekMod.instance, Gui.CRUSHER.ordinal(), world, x, y, z);
		return true;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack itemstack)
	{
		...
		if (itemstack != null && itemstack.getItem() instanceof ItemBlockCrusher)
		{
			ItemBlockCrusher itemBlock = (ItemBlockCrusher)itemstack.getItem();
	...
	public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune)
	{
		...
		if (item != null && item instanceof ItemBlockCrusher)
		{
			ItemBlockCrusher itemBlock = (ItemBlockCrusher)item;
